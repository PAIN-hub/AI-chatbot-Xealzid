"""
Django settings for xealzid project.
...
SECRET_KEY = 'django-insecure-=qb)th0-zr^bfv+9=93c2s&#$g)-4=h7wmrhxh)$jrj^sgax6w'
...
WSGI_APPLICATION = 'xealzid.wsgi.application'
